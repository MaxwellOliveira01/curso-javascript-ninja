...
for(let i = 1; i < 11; i++){
    console.log(isTruthy(i)); //retorna true dez vezes
}
...
carro.obterMarcaModelo(); //Este carro é um Ford Mustang
...
carro.adicionarPessoas(10); //neste momento só caberiam mais 4, entao nao adiciona nada.
